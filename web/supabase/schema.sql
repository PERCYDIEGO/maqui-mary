...
create table if not exists productos (
  ...
  activo boolean default true,  -- era is_active, renombrado para consistencia con el código
...
-- FACTURAS (incluye documentos SUNAT y pedidos del landing page)
...
-- APP_CONFIG (configuración del sitio web)
